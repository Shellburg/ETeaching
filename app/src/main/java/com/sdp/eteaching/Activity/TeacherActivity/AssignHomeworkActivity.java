...
public class AssignHomeworkActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                for (Iterator iterator = classIDSet.iterator(); iterator.hasNext();) {
                    ...
                    Intent intent1=new Intent(AssignHomeworkActivity.this,SetHomeworkActivity.class);

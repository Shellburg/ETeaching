...
public class ItemBean {
    ...
    private String class_id_homework;
    private String class_name_homework;
    private String school_name_homework;
    private boolean isSelect;
    private boolean isShowCheckBox;

    public ItemBean(String class_id_homework, String class_name_homework, String school_name_homework, boolean isSelect, boolean isShowCheckBox) {
    ...
    public String getClass_id_homework() {
        return class_id_homework;
    }

    public void setClass_id_homework(String class_id_homework) {
        this.class_id_homework = class_id_homework;
    }

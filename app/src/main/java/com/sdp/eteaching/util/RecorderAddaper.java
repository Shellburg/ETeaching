...
public class RecorderAdapter extends ArrayAdapter<TeacherMainActivity.Recorder> {
    ...
    public RecorderAdapter(@NonNull Context context, List<TeacherMainActivity.Recorder> datas) {

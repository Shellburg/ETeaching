...
public class TeacherRecorderAdapter extends ArrayAdapter<TeacherAudioActivity.Recorder> {
    ...
    public TeacherRecorderAdapter(@NonNull Context context, List<TeacherAudioActivity.Recorder> datas) {
